    ...
    <>
      ...
      <motion.div
        ...
        <p className="text-secondary text-[17px] md:w-2/3 leading-[30px]">
          Welcome to my site to give you a glimpse into who I am as an individual and to showcase the
          experiences and opportunities that have helped shape me into who I am.
        ...
        <div className="md:w-1/3 flex justify-center">
          <img
            src="/graduation.png"
            alt="Graduation"
            className="w-full max-w-[250px] rounded-lg shadow-lg object-cover"
          />
        </div>
      </motion.div>
